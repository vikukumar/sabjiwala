...
const badgeVariants = {
  ...
  warning: "bg-amber-100 dark:bg-amber-955/40 text-amber-700 dark:text-amber-400",
  ...
  pending: "bg-amber-100 dark:bg-amber-955/40 text-amber-700 dark:text-amber-400",
