 ...
 */
export async function encryptPayload(payload: Record<string, any>): Promise<EncryptedPayload | Record<string, any>> {
  try {
    ...
    Object.defineProperty(result, "_rawPayload", {
      value: payload,
      enumerable: false,
      writable: true,
      configurable: true
    ...
    console.warn("E2EE Encryption failed, falling back to plain payload", err);
    return payload;
  }
}
