...
async def seed_system_settings(db: AsyncSession):
    defaults = [
        ...
        {"key": "about_us", "value": "Sbjiwala is a direct-to-home hyper-local quick commerce platform delivering fresh farm vegetables and fruits straight from local farms to your home with ultra-fast delivery.", "value_type": "string", "group": "policy", "description": "About Us content", "is_public": True},
        {"key": "how_it_works", "value": "Our system detects your precise coordinates, displays catalog stock from the nearest vendor, dispatches the order to a nearby delivery boy, and delivers fresh and fast.", "value_type": "string", "group": "policy", "description": "How it works description", "is_public": True},
