...
export default function ErrorPage({ error, reset }: ErrorProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#090d10] text-slate-800 dark:text-slate-100 flex flex-col items-center justify-center p-6 transition-colors duration-200">
        ...
        <div className="w-full flex justify-center py-6">
          ...
          >
            ...
            <g className="carrot-group" transform="rotate(-15 100 120)">
              ...
              />
              <path
                d="M100 45 C110 20, 120 15, 125 10 C115 20, 105 30, 100 45 Z"
                fill="#22c55e"
              />
              <path
              ...
              <path
                d="M93 100 Q96 97 98 100 T103 100 T107 100"
                stroke="#1e293b"
                strokeWidth="3"
                strokeLinecap="round"
                fill="none"
