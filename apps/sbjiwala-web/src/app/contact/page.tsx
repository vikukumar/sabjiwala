      ...
      {submitted ? (
        <div className="max-w-2xl mx-auto px-4 py-16 text-center space-y-6 animate-fade-in font-sans">
          ...
          <button
            ...
            className="bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-xs px-6 py-3 rounded-xl transition-all shadow-md uppercase tracking-wider cursor-pointer"
          >
                ...
                <div className="space-y-4">
                  <div className="flex gap-3.5 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500 font-semibold">Mon-Sat, 6:00 AM - 9:00 PM</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3.5 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500 font-semibold">For general support & disputes</p>
                    </div>
                  </div>
