    ...
    <PublicPageWrapper>
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-12 font-sans">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-slate-905 dark:text-white tracking-tight leading-tight">
          ...
          <div className="space-y-4 max-w-xl relative z-10">
            ...
            <div className="pt-2 flex flex-wrap gap-3">
              <a href="https://github.com" target="_blank" rel="noopener noreferrer">
                <Button className="bg-emerald-600 hover:bg-emerald-555 text-white font-extrabold flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs shadow-md">
