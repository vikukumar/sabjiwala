...
1. **Description**: Detail the nature of the vulnerability.
2. **Impact**: Explain the potential security risk and exploitability (e.g. Privilege Escalation, SQL Injection, OAuth token leakage).
3. **PoC (Proof of Concept)**: Provide step-by-step instructions or scripts to reproduce the issue.
4. **Resolution (Optional)**: If you have a fix or mitigation strategy, please share it.
